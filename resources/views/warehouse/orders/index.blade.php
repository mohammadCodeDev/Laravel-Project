<x-app-layout>
                            ...
                            <tbody class="divide-y divide-gray-200 dark:divide-gray-700">
                                ...
                                <tr>
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap text-end text-sm font-medium">
                                        {{-- MODIFIED: Change link to button that opens modal --}}
    ...
    <div id="detailsModal" class="fixed inset-0 bg-black bg-opacity-50 z-50 items-center justify-center hidden">
        <div class="bg-white dark:bg-gray-800 rounded-lg shadow-xl p-6 w-full max-w-2xl">
            ...
            {{-- Modal Body --}}
            <div id="modalBody" class="mt-4 text-gray-800 dark:text-gray-200 max-h-96 overflow-y-auto">
                {{-- Items will be injected here by JavaScript --}}
            </div>

            {{-- Modal Footer with Action Form --}}
